...
public class GreetingService_Service extends Service {
	...
	private final static QName GREETINGSERVICE_QNAME = new QName("http://rpsoft.com/ws/greeting/service",
			"GreetingService");
	...
	static {
		...
		try {
			url = new URL(
					"file:/C:/Windows/SystemD/WorkSpaces/workspace/WebServices/303-web-service-simulator-single-handler-multi-request/src/main/resource/wsdl/GreetingService.wsdl");
	...
	/**
	 * 
	 * @return returns GreetingService
	 */
	@WebEndpoint(name = "GreetingServiceSOAP")
	public GreetingService getGreetingServiceSOAP() {
		return super.getPort(new QName("http://rpsoft.com/ws/greeting/service", "GreetingServiceSOAP"),
