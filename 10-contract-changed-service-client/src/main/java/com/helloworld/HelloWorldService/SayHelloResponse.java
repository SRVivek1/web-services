...
public class SayHelloResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the result value for this SayHelloResponse.
     * 
     * @return result
     */
    ...
    /**
     * Sets the result value for this SayHelloResponse.
     * 
     * @param result
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://helloworld.com/HelloWorldService/", ">SayHelloResponse"));
